 ...
 <?php
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            ...
            echo "<td style='text-align:center'><button class='update-btn btn openModalBtn' onclick=\"loadData('".$row['date']."','".$row['event_details']."','".$row['time']."','".$row['email2']."','".$row['id']."')\">Update</button></td>";
...
function loadData(date,event_details,time,email2,id){
